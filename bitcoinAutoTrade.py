...
def get_target_price(ticker, k):
    ...
    df = pyupbit.get_ohlcv(ticker, interval="minute240", count=12)
...
def get_ma15(ticker):
    """15일 이동 평균선 조회"""
    df = pyupbit.get_ohlcv(ticker, interval="minute240", count=90)
...
while True:
    try:
        ...
        end_time = start_time + datetime.timedelta(minute240=6)
